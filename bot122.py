...
def next_question(update: Update, _: CallbackContext):
    ...
    # If the test is completed, show results as a "fake" last question
    if 'test_completed' in user_data and user_data['test_completed']:
...
def show_results(update: Update, _: CallbackContext):
    # We won't use this function for showing results anymore
    pass
